package cn.edu.ustc.clientcard.test;
...
public class CardServiceBeanTest {
	...
	public void setUp() throws Exception {
		...
		//cardService = (CardService) applicationContext.getBean("cardServiceBean");
		//trnMidService = (TrnMidService) applicationContext.getBean("trnMidServiceBean");
		//trnNcService = (TrnNcService) applicationContext.getBean("trnNcServiceBean");
